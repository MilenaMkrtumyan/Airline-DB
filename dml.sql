...
(registration_no, model, seat_capacity, manufacture_year,
 aircraft_status, last_maintenance_date, next_maintenance_date)
VALUES
('No-0001', 'Airbus A321', 220, 2023,
 'Maintenance', CURRENT_DATE, CURRENT_DATE + INTERVAL '180 days')
...
(fname, lname, email, phone_number, passport_no, passport_expiry, date_of_birth, nationality)
VALUES
('John', 'Smith', 'passenger1@gmail.com', '+37494000000',
 'PX999999', '2032-12-31', '1995-05-10', 'Armenian')
